...
{
    public class EmployeeShiftViewService : AppService<EmployeeFinalShifts>, IEmployeeShiftViewService
    {
        #region Repositories
        private readonly IGenericRepository<EmployeeFinalShifts> _genericRepository;

        public EmployeeShiftViewService(IGenericRepository<EmployeeFinalShifts> genericRepository) : base(genericRepository)
        {
            ...
            DateTime? startDate = null)
        {
            ...
            var result = grouped.Select(g =>
            {
                ...
                {
                    //EmployeeFinalShiftID = first.EmployeeFinalShiftID,
