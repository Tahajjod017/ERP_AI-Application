...
namespace GCTL.Service.CRM.Customer
{
    public interface ICustomerService
    {
        ...
        Task<PaginationService<CompanyBranches, BranchVM>.PaginationResult<BranchVM>>
         GetAllBranchAsync( int companyID, int organizationID, int pageNumber = 1, int pageSize = 5, string searchTerm = "", string sortColumn = "BranchName", string sortOrder = "asc");
