...
namespace GCTL_App.Controllers.MasterSetup
{
    public class PaymentModesController : BaseController
    {
        ...
        public PaymentModesController(IPaymentModeService paymentModeService, ITranslateService translationService, ITranslateService translateService, IUserProfileService userProfileService) : base(translateService, userProfileService)
        {
