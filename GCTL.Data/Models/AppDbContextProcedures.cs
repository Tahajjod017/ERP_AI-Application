...
namespace GCTL.Data.Models
{
    ...
    public partial class AppDbContextProcedures : IAppDbContextProcedures
    {
        ...
        public virtual async Task<int> aaAsync(string? tableName, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default)
        {
            ...
            var _ = await _context.Database.ExecuteSqlRawAsync("EXEC @returnValue = [dbo].[aa] @TableName = @TableName", sqlParameters, cancellationToken ?? CancellationToken.None);
        ...
        public virtual async Task<List<ccResult>?> ccAsync(string? schemaTables, string? columnPositions, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var sqlParameters = new []
            {
                new SqlParameter
                {
                    ParameterName = "SchemaTables",
                    Size = -1,
                    Value = schemaTables ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.NVarChar,
                },
                new SqlParameter
                {
            ...
            var _ = await _context.SqlQueryAsync<ccResult>("EXEC @returnValue = [dbo].[cc] @SchemaTables = @SchemaTables, @ColumnPositions = @ColumnPositions", sqlParameters, cancellationToken);
        ...
        public virtual async Task<int> Prc_GetEmployeesPagedAsync(int? pageNumber, int? pageSize, string? searchTerm, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default)
        {
            ...
            var _ = await _context.Database.ExecuteSqlRawAsync("EXEC @returnValue = [dbo].[Prc_GetEmployeesPaged] @PageNumber = @PageNumber, @PageSize = @PageSize, @SearchTerm = @SearchTerm", sqlParameters, cancellationToken ?? CancellationToken.None);
        ...
        public virtual async Task<int> SeedDateForSCAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default)
        {
            ...
            var _ = await _context.Database.ExecuteSqlRawAsync("EXEC @returnValue = [dbo].[SeedDateForSC]", sqlParameters, cancellationToken ?? CancellationToken.None);
        ...
        public virtual async Task<int> sp_processFinalAttAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default)
        {
            ...
            var _ = await _context.Database.ExecuteSqlRawAsync("EXEC @returnValue = [dbo].[sp_processFinalAtt]", sqlParameters, cancellationToken ?? CancellationToken.None);
