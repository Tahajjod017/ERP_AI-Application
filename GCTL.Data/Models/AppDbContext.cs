...
public partial class AppDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EmployeeBaseAllowances>(entity =>
        {
            ...
            entity.HasOne(d => d.EmployeeAllowanceType).WithMany(p => p.EmployeeBaseAllowances)
                .HasForeignKey(d => d.EmployeeAllowanceTypeID)
                .HasConstraintName("FK_EmployeeAllowanceTypes_EmployeeAllowanceTypeID_EmployeeBaseAllowances");
