...
.HasValue<ApplicationUser>("ApplicationUser");
        ...
        {
            entity.HasKey(e => e.ReqItemApprovalHistoryID).HasName("PK__ReqAppro__D27A2A30C3863053");
            ...
            entity.HasOne(d => d.ApprovalType).WithMany(p => p.ReqApprovalSettings)
                .HasForeignKey(d => d.ApprovalTypeID)
                .HasConstraintName("FK__ReqApprov__Appro__38453051");

            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.ReqApprovalSettingsCreatedByNavigation)
                .HasForeignKey(d => d.CreatedBy)
                .HasConstraintName("FK__ReqApprov__Creat__3A2D78C3");

            entity.HasOne(d => d.DeletedByNavigation).WithMany(p => p.ReqApprovalSettingsDeletedByNavigation)
                .HasForeignKey(d => d.DeletedBy)
                .HasConstraintName("FK__ReqApprov__Delet__3D09E56E");

            entity.HasOne(d => d.OrganizationBranch).WithMany(p => p.ReqApprovalSettings)
                .HasForeignKey(d => d.OrganizationBranchID)
                .HasConstraintName("FK__ReqApprov__Organ__37510C18");

            entity.HasOne(d => d.Organization).WithMany(p => p.ReqApprovalSettings)
                .HasForeignKey(d => d.OrganizationID)
                .HasConstraintName("FK__ReqApprov__Organ__365CE7DF");

            entity.HasOne(d => d.SelfExceptionApproval).WithMany(p => p.ReqApprovalSettingsSelfExceptionApproval)
                .HasForeignKey(d => d.SelfExceptionApprovalID)
                .HasConstraintName("FK__ReqApprov__SelfE__3939548A");

            entity.HasOne(d => d.UpdatedByNavigation).WithMany(p => p.ReqApprovalSettingsUpdatedByNavigation)
                .HasForeignKey(d => d.UpdatedBy)
                .HasConstraintName("FK__ReqApprov__Updat__3B219CFC");
        });
