...
{
    public class UpdateTransactionAccountVM : BaseViewModel
    {
        ...
        [Required(ErrorMessage = "{0} is required!"), StringLength(10, ErrorMessage = "{0} must be at most {1} characters long."), Display(Name = "Transaction Account Code")]
